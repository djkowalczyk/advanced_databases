...
{" (found before start of program)",
 " (in '/root/dupa/advanced_databases/AD_lab3/code.stan', line 2, column 4 to column 15)",
 " (in '/root/dupa/advanced_databases/AD_lab3/code.stan', line 4, column 4 to column 52)",
 " (in '/root/dupa/advanced_databases/AD_lab3/code.stan', line 5, column 4 to column 49)"};
...
class code_model final : public model_base_crtp<code_model> {
 ...
 public:
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"N\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"},{\"name\":\"p\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"y\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
