...
static constexpr std::array<const char*, 23> locations_array__ =
  ...
  " (in '/content/code_5.stan', line 9, column 4 to column 24)",
  " (in '/content/code_5.stan', line 10, column 4 to column 19)",
  " (in '/content/code_5.stan', line 14, column 4 to column 17)",
  " (in '/content/code_5.stan', line 23, column 4 to column 22)",
  " (in '/content/code_5.stan', line 24, column 4 to column 25)",
  " (in '/content/code_5.stan', line 15, column 4 to column 16)",
  " (in '/content/code_5.stan', line 26, column 8 to column 52)",
  " (in '/content/code_5.stan', line 27, column 8 to column 44)",
  " (in '/content/code_5.stan', line 25, column 19 to line 28, column 5)",
  " (in '/content/code_5.stan', line 25, column 4 to line 28, column 5)",
  " (in '/content/code_5.stan', line 19, column 4 to column 26)",
  " (in '/content/code_5.stan', line 2, column 4 to column 10)",
  " (in '/content/code_5.stan', line 3, column 4 to column 10)",
  " (in '/content/code_5.stan', line 4, column 10 to column 11)",
  " (in '/content/code_5.stan', line 4, column 4 to column 20)",
  " (in '/content/code_5.stan', line 5, column 11 to column 12)",
  " (in '/content/code_5.stan', line 5, column 14 to column 15)",
  " (in '/content/code_5.stan', line 5, column 4 to column 19)",
  " (in '/content/code_5.stan', line 10, column 11 to column 12)",
  " (in '/content/code_5.stan', line 14, column 11 to column 12)",
  " (in '/content/code_5.stan', line 23, column 11 to column 12)",
  " (in '/content/code_5.stan', line 24, column 11 to column 12)"};
class code_5_model final : public model_base_crtp<code_5_model> {
 ...
 public:
  ~code_5_model() {}
  code_5_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "code_5_model_namespace::code_5_model";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "code_5_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "code_5_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
